...
<aside id="side-overlay" class="font-size-sm">
    ...
    <div class="content-header border-bottom">
        ...
        <!-- User Info -->
        <div class="ml-2">
            <a class="link-fx text-dark font-w600" href="javascript:void(0)"> Nama User </a>
        </div>
        <!-- END User Info -->
    ...
    <div class="content-header bg-white-5">
        ...
        <a class="font-w600 text-dual" href="">
            ...
            <span class="smini-hide">
                <span class="font-w700 font-size-h5"> Surat </span> <span class="font-w400"> KMFT </span>
            </span>
        </a>
        <!-- END Logo -->
